(function() {
    ...
    function checkWebviewCustomUA(a) {
        for (var b = ["daum", "naver", "google", "facebook", "twitter"], c = !1, d = 0, e = b.length; e > d; d++)
            if (a.indexOf(b[d]) > -1) {
                c = !0;
                break
            }
    ...
    postcodeUtils.isArray = function(a) {
        ...
        if (a) {
            ...
            if ("[object array]" === c || "[object nodelist]" === c || "[object htmlcollection]" === c || b && a instanceof b)
                return !0
        }
        return !1
    }
    ...
    postcodeUtils.userAgent = function(a) {
        function b(a) {
            ...
            return "webkit" === d[1] ? d = /(iphone|ipad|ipod)[\S\s]*os ([\w._\-]+) like/.exec(a) || /(android)[ \/]([\w._\-]+);/.exec(a) || [d[0], "safari", d[2]] : "mozilla" === d[1] ? d[1] = "firefox" : /polaris|natebrowser|([010|011|016|017|018|019]{3}\d{3,4}\d{4}$)/.test(a) ? d[1] = "polaris" : "rv" === d[1] && (d[1] = "msie"),
            b[d[1]] = !0,
            b.name = d[1],
            b.version = c(d[2]),
            b
    ...
    postcodeUtils.isAndroidWebview = function(a) {
        for (var b = ["version/", "samsungbrowser", "daum", "naver", "google", "facebook", "twitter"], c = !1, d = 0, e = b.length; e > d; d++)
            if (a.indexOf(b[d]) > -1) {
                c = !0;
                break
            }
    ...
    postcodeUtils.isAndroidNaverWebview = function(a) {
        for (var b = ["naver"], c = !1, d = 0, e = b.length; e > d; d++)
            if (a.indexOf(b[d]) > -1) {
                c = !0;
                break
            }
    ...
    postcodeUtils.isIOSWebview = function(a) {
        for (var b = ["version/7", "version/8", "version/9", "version/10", "version/11", "version/12", "version/13", "version/14", "version/15"], c = 0, d = 0, e = b.length; e > d; d++)
            -1 === a.indexOf(b[d]) && c++;
        return c === b.length ? !0 : checkWebviewCustomUA(a)
    }
    ,
    postcodeUtils.isDaumapps = function(a) {
        for (var b = ["daumapps"], c = 0, d = 0, e = b.length; e > d; d++)
            a.indexOf(b[d]) > -1 && c++;
        return c === b.length
    }
    ,
    postcodeUtils.isMobileChrome = function(a) {
        for (var b = ["crios", "chrome"], c = 0, d = 0, e = b.length; e > d; d++)
            a.indexOf(b[d]) > -1 && c++;
        return c > 0
    }
    ,
    postcodeUtils.encodeData = function(a) {
        var b = "";
        for (var c in a)
            a.hasOwnProperty(c) && (b += c + "=" + encodeURIComponent(a[c]) + "|");
    ...
    !function(a, b, c, d, e) {
        ...
        a.viewUtils = function() {
            function b(a, b, d, e, f, h) {
                "msie" !== g.browser.name || 7 !== parseInt(g.browser.version.major, 10) || c.postMessage ? "msie" !== g.browser.name || 6 !== parseInt(g.browser.version.major, 10) || c.postMessage || (h += 60,
                a.document.getElementById(e).style.height = h - 4 + "px",
                a.document.getElementById(e).style.width = b.offsetWidth - 4 + "px",
                b.style.height = h + "px",
                d.style.height = h + "px") : (a.document.getElementById(e).style.height = h - 4 + "px",
                a.document.getElementById(e).style.width = b.offsetWidth - 4 + "px",
                b.style.height = h + "px",
                d.style.height = h + "px")
            }
            function e(a, b, c) {
                var d = !1;
                if (a && !isNaN(a))
                    a = parseInt(a, 10) < c ? c : parseInt(a, 10);
            ...
            function j(a, b) {
                if (b) {
                    ...
                    a ? (a.appendChild(b),
                    q.TARGET_MAP[b.id] = a) : (d.body.appendChild(b),
                    q.TARGET_MAP[b.id] = d.body)
                }
            }
            function k(a, b) {
                b && (a ? q.TARGET_MAP[b.id] === a && (a.removeChild(b),
                q.TARGET_MAP[b.id] = null) : (d.body.removeChild(b),
                q.TARGET_MAP[b.id] = null))
            }
            function l(a, b, c) {
                var d = ""
                  , e = 1e3
                  , f = a + c;
                return f.length > e ? (f = a + b,
                d = f.length > e ? a : f) : d = f,
                d
            }
            function m(a, b) {
                n(a, b) || (q.POPUP_MAP[a] || (q.POPUP_MAP[a] = []),
                q.POPUP_MAP[a].push({
                    ref: b,
                    data: {
        ...
        a.common = function() {
            function b(a) {
                var b = {}
                  , c = "done" === a.action ? !0 : !1;
                for (var d in a)
                    a.hasOwnProperty(d) && "action" !== d && (c ? b[d] = a[d] : b[d] = isNaN(a[d]) ? a[d] : parseInt(a[d], 10));
                return b
            }
            function d(a, b) {
                var c = a + "_" + b
            ...
            function g(a, d, e) {
                !c.postMessage || "function" != typeof c.postMessage && "object" != typeof c.postMessage ? (a.name = "",
                ...
                e.timer = setInterval(function() {
                    try {
                        if ("" !== a.name) {
                            ...
                            d(i, j),
                            a.name = "",
                            "done" === i && e.autoClose && e.onComplete !== h.EMPTY_FUNCTION && (clearInterval(e.timer),
                            e.timer = null)
                        }
                    } catch (k) {
                        clearInterval(e.timer)
                    }
                }, 200)) : (a.customMessageHandler && f.event.off(a, "message", a.customMessageHandler),
        ...
        a.frame = function() {
            function a(a) {
                var b = {
                  ...
                  , c = {
                    ...
                    a51: f.userAgent.os.android && f.isAndroidWebview(f.userAgent.ua_string) && f.userAgent.ua_string.indexOf("android 5.1") > -1 ? "on" : "off"
                };
                a.userQuery && (c.userQuery = a.userQuery,
                c.cq = a.cq),
                a.region_name && (c.region_name = a.region_name,
                c.cq = a.cq,
                c.intsh = a.intsh),
                a.theme && "" !== a.theme.themeStr && (c.theme = a.theme.themeStr,
                c.bit = a.theme.bit,
                c.sit = a.theme.sit,
                c.sgit = a.theme.sgit,
                c.sbit = a.theme.sbit,
            ...
            function b(a) {
                var b = d.createElement("div")
                  , c = null;
                return c = f.userAgent.os.ios ? parseInt(f.userAgent.browser.version.major, 10) >= 13 ? {
            ...
            function e() {
                ...
                return f.userAgent.os.ios && f.isIOSWebview(f.userAgent.ua_string) && (b = {
                    width: "100%",
                    height: "100%",
                    border: "0 none",
                    margin: "0",
            ...
            function k(a, c) {
                if (null === q)
                    return alert("POPUP URL�� �뗮똿�� 二쇱꽭��.");
                var d = b(a)
                  , g = e();
                return d.id = j.setId("layer", a.viewerNo),
                g.src = "about:blank",
                d.appendChild(g),
                h.append(c, d),
                f.userAgent.os.android && f.isAndroidWebview(f.userAgent.ua_string) ? setTimeout(function() {
                    l(g, d, a, c)
            ...
            function l(b, c, d, e) {
                ...
                h.setFrameStyle(f.document.getElementsByTagName("html")[0], f.document.getElementsByTagName("body")[0]),
                f.document.close(),
                j.setReady(f, function(a, i) {
                    if ("reload" === a) {
                        if (b.focus(),
                        f && f.document) {
                            var k = f.document.getElementById(j.getId("viewerFrame", d.viewerNo));
                            k && k.focus()
                        }
                    } else
                        "search" === a ? d.onSearch !== g.EMPTY_FUNCTION && d.onSearch(i) : "resize" === a ? d.onResize !== g.EMPTY_FUNCTION && (d.onResize(i),
                        h.adjustLowIE(f, b, c, j.getId("viewerFrame", d.viewerNo), i.width, i.height)) : "done" === a && d.onComplete !== g.EMPTY_FUNCTION && setTimeout(function() {
                            d.onComplete(i),
                            d.autoClose && (h.IE11CompatibleBugFix(f),
                            h.remove(e, c),
            ...
            function m(a) {
                ...
                if (null == e)
                    return alert("�앹뾽�� �� �� �놁뒿�덈떎.\n釉뚮씪�곗��� �앹뾽 李⑤떒 湲곕뒫�� �쒖꽦�� �섏뼱 �덈뒗吏� �뺤씤�댁＜�몄슂.");
                j.setId("popup", a.viewerNo),
                h.setPopupMap(j.getId("popup", a.viewerNo), e);
                try {
                    e.focus()
                } catch (i) {}
                if (a.popupName && o(e),
            ...
            function n(b, c) {
                ...
                h.setFrameStyle(d.document.getElementsByTagName("html")[0], d.document.getElementsByTagName("body")[0]),
                d.document.close();
                try {
                    ...
                    if (e) {
                        ...
                        i.innerHTML = f,
                        e.appendChild(i)) : (i = d.document.createElement("title"),
                        i.innerHTML = f,
                        k = d.document.createElement("meta"),
                        k.name = "viewport",
                        k.content = "user-scalable=no,initial-scale=1.0,maximum-scale=1.0,minimum-scale=1.0,width=device-width",
                        e.appendChild(i),
                        e.appendChild(k))
                    }
                } catch (m) {}
                j.setReady(d, function(a, d) {
                    "done" === a ? c.onComplete !== g.EMPTY_FUNCTION && setTimeout(function() {
                        if (c.onComplete(d),
                        c.autoClose)
                            if (c.onClose !== g.EMPTY_FUNCTION) {
                                var a = h.getPopupMap(b);
                                a && clearInterval(a.data.closeCallbackTimer),
                                b.close(),
                                c.onClose(g.POPUP_CLOSE_STATE.COMPLETE)
                            } else
                                b.close()
                    }, 0) : "search" === a && c.onSearch !== g.EMPTY_FUNCTION && c.onSearch(d)
                }, c)
            }
            function o(a) {
                var b = a.window
        ...
        a.themePreprocessor = function() {
            ...
            function d(a, b) {
                var c = n(a)
                  ...
                  , f = o(c.r, c.g, c.b)
                  , g = o(d.r, d.g, d.b);
                Math.abs(f.l - g.l) < e && (f.l >= g.l ? (g.l -= e - Math.abs(f.l - g.l),
                g.l = g.l < 0 ? g.l + 1 : g.l) : f.l < g.l && (g.l += e - Math.abs(f.l - g.l),
                g.l = g.l > 1 ? g.l - 1 : g.l));
                var h = p(g.h, g.s, g.l);
            ...
            function o(a, b, c) {
                ...
                b /= 255,
                c /= 255;
                var d, e, f = Math.max(a, b, c), g = Math.min(a, b, c), h = (f + g) / 2;
                if (f === g)
                    d = e = 0;
                else {
                    var i = f - g;
            ...
            var s = {
              ...
              , v = [{
                ...
                keys: [s.CONTENT_BG],
                match: [["RESULT_ADDRESS.addrTypeLabelOutline", "#d4e2ef"], ["RESULT_ADDRESS.moreRelAddrBtnBg", "#959595"], ["RESULT_ADDRESS.engMapBtnDividingLine", "#cfcfcf"]],
                modifier: d
            }, {
                keys: [s.CONTENT_BG],
                match: [["SUGGEST.itemOver", "#f4f4f4"], ["FILTER_ADDRESS.focusBg", "#efefef"]],
                modifier: h
            }, {
                keys: [s.PAGE_BG],
                ...
                keys: [s.BG],
                match: [["LOGO.text", "#888"], ["LOGO.logoTextDividingLine", "#dcdcdc"]],
                modifier: d
            }, {
                keys: [s.TEXT],
                match: [["INFO.exampleText", "#008bd3"], ["SEARCH_GUIDE.exampleText", "#008bd3"]],
                modifier: d
            }];
            return {
    ...
    !function(a, b, c, d, e) {
        ...
        function j(a) {
            ...
            c.onComplete && "function" == typeof c.onComplete && c.onComplete !== l.EMPTY_FUNCTION ? c.onComplete = c.onComplete : c.oncomplete && "function" == typeof c.oncomplete && c.oncomplete !== l.EMPTY_FUNCTION ? c.onComplete = c.oncomplete : (c.onComplete = l.EMPTY_FUNCTION,
            c.oncomplete = l.EMPTY_FUNCTION,
            c.isViewerMode = !0),
            c.onResize && "function" == typeof c.onResize && c.onResize !== l.EMPTY_FUNCTION ? c.onResize = c.onResize : c.onresize && "function" == typeof c.onresize && c.onresize !== l.EMPTY_FUNCTION ? c.onResize = c.onresize : (c.onResize = l.EMPTY_FUNCTION,
            c.onresize = l.EMPTY_FUNCTION),
            c.onClose && "function" == typeof c.onClose && c.onClose !== l.EMPTY_FUNCTION ? c.onClose = c.onClose : c.onclose && "function" == typeof c.onclose && c.onclose !== l.EMPTY_FUNCTION ? c.onClose = c.onclose : (c.onClose = l.EMPTY_FUNCTION,
            c.onclose = l.EMPTY_FUNCTION),
            c.onSearch && "function" == typeof c.onSearch && c.onSearch !== l.EMPTY_FUNCTION ? c.onSearch = c.onSearch : c.onsearch && "function" == typeof c.onsearch && c.onsearch !== l.EMPTY_FUNCTION ? c.onSearch = c.onsearch : (c.onSearch = l.EMPTY_FUNCTION,
            c.onsearch = l.EMPTY_FUNCTION),
            ...
            "boolean" != typeof c.focusInput && (c.focusInput = !0),
            "boolean" != typeof c.focusContent && (c.focusContent = !0),
            ...
            "boolean" != typeof c.alwaysShowEngAddr ? c.alwaysShowEngAddr = !1 : c.alwaysShowEngAddr && (c.hideEngBtn = !0),
            "boolean" != typeof c.submitMode && (c.submitMode = !0),
            "boolean" != typeof c.useSuggest && (c.useSuggest = !0),
            "boolean" != typeof c.autoHiddenSuggest && (c.autoHiddenSuggest = !1),
            isNaN(c.pleaseReadGuide) || "number" != typeof c.pleaseReadGuide ? c.pleaseReadGuide = 0 : (c.pleaseReadGuide = parseInt(c.pleaseReadGuide, 10),
            c.pleaseReadGuide <= 2 && (c.pleaseReadGuide = 0),
            c.pleaseReadGuide > 20 && (c.pleaseReadGuide = 20)),
            isNaN(c.pleaseReadGuideTimer) || "number" != typeof c.pleaseReadGuideTimer ? c.pleaseReadGuideTimer = 1.5 : (c.pleaseReadGuideTimer = parseFloat(c.pleaseReadGuideTimer),
            c.pleaseReadGuideTimer <= 0 && (c.pleaseReadGuideTimer = 1.5),
            c.pleaseReadGuideTimer > 60 && (c.pleaseReadGuideTimer = 1.5)),
            isNaN(c.maxSuggestItems) || "number" != typeof c.maxSuggestItems ? c.maxSuggestItems = 10 : (c.maxSuggestItems = parseInt(c.maxSuggestItems, 10),
            ...
            "boolean" != typeof c.allAddr && (c.allAddr = !1),
            "boolean" != typeof c.zonecodeOnly && (c.zonecodeOnly = !1),
            this._opt_ = c
        }
        var k = b
          , l = a.CONT
