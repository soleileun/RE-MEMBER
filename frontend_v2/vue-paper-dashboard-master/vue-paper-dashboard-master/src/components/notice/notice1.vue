    ...
    <div class="container-fluid">
        ...
        <div class="container">
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-1 "  > 
                <select name="standard" id="standard2" >
              ...
              <div class="col-8"> 
                <input type="text" placeholder="검색어를 입력하세요" id="searchWord2" style="width:100%;"/>
              </div>
              
              <div class="col-2 "  > 
                 <button v-on:click="searchNotice" style="border: 2px solid rgb(173, 203, 247); border-radius:10px; width:80%;">검색</button>
              </div>
