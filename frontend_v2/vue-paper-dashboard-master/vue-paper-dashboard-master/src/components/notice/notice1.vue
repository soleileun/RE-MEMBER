<template>
  ...
  <!-- 디비에 들어갈 조건들 : {{selected}} + {{searchWord}} <br> -->
    ...
    <div class="container-fluid">
        ...
        <select name="standard" id="standard2" style="height:30px; margin-right:20px; width:80px;">
          <option value="t" selected >제목</option>
          <option value="w">작성자</option>
        </select>
        <input type="text" placeholder="검색어를 입력하세요" id="searchWord2" style="margin-right:20px; width:400px;"/>
          <button v-on:click="searchNotice" style="border: 2px solid rgb(173, 203, 247); border-radius:10px;">검색</button>
