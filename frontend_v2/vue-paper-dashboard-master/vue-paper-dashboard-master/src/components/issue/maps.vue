<template>
  <div id="dmap">
    <div>
      ...
      <button @click="testing()">위치 입력</button>
      <!-- <button onclick="javascript:address()" type="submit">주소 검색
      api</button>-->
      <button @click="address()">주소 검색 api</button>
      <br />
    </div>
...
export default {
  ...
  methods: {
    ...
    earchDetailAddrFromCoords(coords, callback) {
    ...
    testing() {
      ...
      this.geocoder.addressSearch(input, function (result, status) {
        // 정상적으로 검색이 완료됐으면
        if (status === kakao.maps.services.Status.OK) {
        ...
        //   console.log("len is " + len);
          ...
          kakao.maps.event.addListener(this.markerCenter, "mouseover", function () {
            // 마커에 마우스오버 이벤트가 발생하면 인포윈도우를 마커위에 표시합니다
            infowindow.open(this.map, this.markerCenter);
          });

          // 마커에 마우스아웃 이벤트를 등록합니다
          kakao.maps.event.addListener(this.markerCenter, "mouseout", function () {
  ...
  mounted() {
    ...
    //       // 마커에 마우스오버 이벤트를 등록합니다
    //       kakao.maps.event.addListener(markerCenter, "mouseover", function () {
    //         // 마커에 마우스오버 이벤트가 발생하면 인포윈도우를 마커위에 표시합니다
    //         infowindow.open(map, markerCenter);
    //       });

    //       // 마커에 마우스아웃 이벤트를 등록합니다
    //       kakao.maps.event.addListener(markerCenter, "mouseout", function () {
    //         // 마커에 마우스아웃 이벤트가 발생하면 인포윈도우를 제거합니다
    //         infowindow.close();
    //       });
    ...
    //this.displayCenterInfosearchAddrFromCoords(this.map.getCenter(), this.displayCenterInfo);
